...
/* package hsmal-0.1.0.0 */
#ifndef VERSION_hsmal
#define VERSION_hsmal "0.1.0.0"
#endif /* VERSION_hsmal */
#ifndef MIN_VERSION_hsmal
#define MIN_VERSION_hsmal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hsmal */
...
#define CURRENT_COMPONENT_ID "hsmal-0.1.0.0-inplace-hsmal"
